...
var MatMenuItem = class _MatMenuItem {
  ...
  _hovered = new import_rxjs2.Subject();
  /** Stream that emits when the menu item is focused. */
  _focused = new import_rxjs2.Subject();
...
var MatMenuContent = class _MatMenuContent {
  ...
  _attached = new import_rxjs2.Subject();
  constructor() {
  }
  /**
...
var MatMenu = class _MatMenu {
  ...
  ngAfterContentInit() {
    ...
    this._directDescendantItems.changes.pipe((0, import_operators2.startWith)(this._directDescendantItems), (0, import_operators2.switchMap)((items) => (0, import_rxjs2.merge)(...items.map((item) => item._focused)))).subscribe((focusedItem) => this._keyManager.updateActiveItem(focusedItem));
  ...
  _hovered() {
    ...
    return itemChanges.pipe((0, import_operators2.startWith)(this._directDescendantItems), (0, import_operators2.switchMap)((items) => (0, import_rxjs2.merge)(...items.map((item) => item._hovered))));
  }
  /*
  ...
  _updateDirectDescendants() {
    this._allItems.changes.pipe((0, import_operators2.startWith)(this._allItems)).subscribe((items) => {
...
var MatMenuTrigger = class _MatMenuTrigger {
  ...
  _overlayRef = null;
  _menuOpen = false;
  _closingActionsSubscription = import_rxjs2.Subscription.EMPTY;
  _hoverSubscription = import_rxjs2.Subscription.EMPTY;
  _menuCloseSubscription = import_rxjs2.Subscription.EMPTY;
  _pendingRemoval;
  /**
  ...
  openMenu() {
    ...
    if (menu instanceof MatMenu) {
      ...
      menu._directDescendantItems.changes.pipe((0, import_operators2.takeUntil)(menu.close)).subscribe(() => {
  ...
  _destroyMenu(reason) {
    ...
    if (menu instanceof MatMenu && this._ownsMenu(menu)) {
      this._pendingRemoval = menu._animationDone.pipe((0, import_operators2.take)(1)).subscribe(() => {
        overlayRef.detach();
  ...
  _menuClosingActions() {
    ...
    const parentClose = this._parentMaterialMenu ? this._parentMaterialMenu.closed : (0, import_rxjs2.of)();
    const hover = this._parentMaterialMenu ? this._parentMaterialMenu._hovered().pipe((0, import_operators2.filter)((active) => this._menuOpen && active !== this._menuItemInstance)) : (0, import_rxjs2.of)();
    return (0, import_rxjs2.merge)(backdrop, parentClose, hover, detachments);
  }
