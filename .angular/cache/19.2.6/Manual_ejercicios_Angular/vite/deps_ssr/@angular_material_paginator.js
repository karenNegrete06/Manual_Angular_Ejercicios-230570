...
import {
  SelectionModel
} from "./chunk-2R5ZXTLJ.js";
import {
  ErrorStateMatcher,
  _ErrorStateTracker
} from "./chunk-GVHU4DVM.js";
import {
  MAT_FORM_FIELD,
  MatFormField,
  MatFormFieldControl,
  MatFormFieldModule
} from "./chunk-QZI5YZSI.js";
import {
  CdkConnectedOverlay,
  CdkOverlayOrigin,
  ComponentPortal,
...
import {
  ...
  NgForm,
  Validators
} from "./chunk-RE42JDRA.js";
import "./chunk-VU57VAYS.js";
import {
  CdkScrollableModule,
  ScrollDispatcher,
  ViewportRuler
} from "./chunk-HIK7U4XU.js";
import {
  MatButtonModule,
  MatIconButton
} from "./chunk-IS7PMXWP.js";
import {
  MatRipple,
  MatRippleModule
} from "./chunk-4TMNOKO6.js";
import {
  _StructuralStylesLoader
} from "./chunk-S6ZO7PEO.js";
import {
  coerceBooleanProperty
} from "./chunk-7LEHMZOP.js";
import "./chunk-NBQ6G47L.js";
import {
  A,
  A11yModule,
...
} from "./chunk-L4GYZWVI.js";
import {
  _CdkPrivateStyleLoader
} from "./chunk-PR7LJHLW.js";
import "./chunk-4A3CXPF2.js";
import {
  Platform,
  coerceNumberProperty
} from "./chunk-Z32PIHZF.js";
import "./chunk-HJTKKQ3X.js";
import {
  Directionality
} from "./chunk-MX3AV6EA.js";
import {
  NgClass
} from "./chunk-CWLKSOI4.js";
import {
  DOCUMENT
} from "./chunk-SD5AH54O.js";
import {
...
// node_modules/@angular/material/fesm2022/module-c1888a58.mjs
...
var MatTooltip = class _MatTooltip {
  ...
  ngAfterViewInit() {
    ...
    this._setupPointerEnterEventsIfNeeded();
    this._focusMonitor.monitor(this._elementRef).pipe((0, import_operators2.takeUntil)(this._destroyed)).subscribe((origin) => {
      if (!origin) {
  ...
  show(delay = this.showDelay, origin) {
    ...
    instance.afterHidden().pipe((0, import_operators2.takeUntil)(this._destroyed)).subscribe(() => this._detach());
    this._setTooltipClass(this._tooltipClass);
    this._updateTooltipMessage();
    instance.show(delay);
  }
  ...
  _createOverlay(origin) {
    ...
    strategy.positionChanges.pipe((0, import_operators2.takeUntil)(this._destroyed)).subscribe((change) => {
    ...
    this._updatePosition(this._overlayRef);
    this._overlayRef.detachments().pipe((0, import_operators2.takeUntil)(this._destroyed)).subscribe(() => this._detach());
    this._overlayRef.outsidePointerEvents().pipe((0, import_operators2.takeUntil)(this._destroyed)).subscribe(() => this._tooltipInstance?._handleBodyInteraction());
    this._overlayRef.keydownEvents().pipe((0, import_operators2.takeUntil)(this._destroyed)).subscribe((event) => {
    ...
    if (!this._dirSubscribed) {
      ...
      this._dir.change.pipe((0, import_operators2.takeUntil)(this._destroyed)).subscribe(() => {
        if (this._overlayRef) {
          this._updatePosition(this._overlayRef);
        }
      });
...
var MatPaginatorIntl = class _MatPaginatorIntl {
   ...
   */
  changes = new import_rxjs4.Subject();
...
var MatPaginator = class _MatPaginator {
  ...
  _initializedStream = new import_rxjs4.ReplaySubject(1);
  /**
