...
var XYChart = class extends SerialChart {
  ...
  _handleZoomOut() {
    ...
    if (zoomOutButton && zoomOutButton.parent) {
      let visible = false;
      this.xAxes.each((axis) => {
        if (round(axis.get("start", 0), 6) != 0 || round(axis.get("end", 1), 6) != 1) {
          visible = true;
        }
      });
      this.yAxes.each((axis) => {
      ...
      if (this._shouldShowBullet(positionX, positionY)) {
        ...
        if (field != void 0) {
          ...
          if (baseAxis == xAxis2) {
            ...
            if (realField) {
              positionY = yAxis2.getDataItemPositionY(dataItem, realField, 0, this.get("vcy", 1));
            ...
            if (realField) {
              positionX = xAxis2.getDataItemPositionX(dataItem, realField, 0, this.get("vcx", 1));
        ...
        if (o.getOpen) {
          ...
          if (valueX != null && valueY != null) {
            ...
            if (o.stacked) {
              ...
              let stackToItemY = dataItem.get("stackToItemY");
              if (stackToItemX) {
                xPos0 = o.xAxis.getDataItemPositionX(stackToItemX, o.xField, itemLocationX2, stackToItemX.component.get("vcx"));
                if (isNaN(xPos0)) {
                  xPos0 = o.basePosX;
                }
              } else {
                if (o.yAxis === o.baseAxis) {
                  ...
                  xPos0 = o.xAxis.getDataItemPositionX(dataItem, o.xOpenField, itemLocationX2, o.vcx);
                }
              }
              if (stackToItemY) {
                yPos0 = o.yAxis.getDataItemPositionY(stackToItemY, o.yField, itemLocationY2, stackToItemY.component.get("vcy"));
                if (isNaN(yPos0)) {
                  yPos0 = o.basePosY;
                }
              } else {
                if (o.xAxis === o.baseAxis) {
                  ...
                  yPos0 = o.yAxis.getDataItemPositionY(dataItem, o.yOpenField, itemLocationY2, o.vcy);
                }
              }
            } else {
              xPos0 = o.xAxis.getDataItemPositionX(dataItem, o.xOpenField, itemLocationX2, o.vcx);
